...
import net.minecraft.client.gui.GuiGraphicsExtractor;import net.minecraft.client.resources.language.I18n;
...
//                            }, MusicHud.EXECUTOR);
    ...
    public void renderFrame(GuiGraphicsExtractor graphics, DeltaTracker deltaTracker) {
        try {
