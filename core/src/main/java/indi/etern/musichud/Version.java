...
public record Version(long mayor, long minor, long patch, BuildType build) implements Comparable<Version>{
    ...
    public static final Version current = new Version(1,3,0, BuildType.PreRelease);
    public static final Version leastCompatible = new Version(1,3,0,BuildType.PreRelease);
